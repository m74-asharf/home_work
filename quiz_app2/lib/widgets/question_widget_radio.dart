...
import 'package:quiz_app2/widgets/custom_answer_radio_widget.dart';
      ...
      child: Column(
        ...
        children: [
          CustomAnswerRadioWidget(
            ...
            radioText: widget.questionModel.answers[0],
            radioValue: answer1,
          ),
          CustomAnswerRadioWidget(
            onChange: (val) {
            ...
            radioText: widget.questionModel.answers[1],
            radioValue: answer2,
          ...
          CustomAnswerRadioWidget(
            ...
            radioText: widget.questionModel.answers[2],
            radioValue: answer3,
          ...
          CustomAnswerRadioWidget(
            ...
            radioText: widget.questionModel.answers[3],
            radioValue: answer4,
          ),
        ],
      ),
